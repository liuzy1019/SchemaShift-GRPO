# AGENTS.md — SchemaShift-GRPO AI 协作约定

> 权威方案文档：`mcp_tools_rl_project_plan.md`。架构、数据、reward、评测、阶段详情全在那里。
> 入口文档：`CLAUDE.md`。
...
- 大改动前先更新 `mcp_tools_rl_project_plan.md`，再改实现
...
- 当前模型已切换为 Qwen3-4B（`models/Qwen3-4B`），7B 相关产物已清理
- SFT 输出目录为 `outputs/sft_cold_start_4b/`
